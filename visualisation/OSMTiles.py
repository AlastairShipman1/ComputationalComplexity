...
def generate_background(limits, origin):
    ...
    padding_factor = config.visualisation_metrics["figure_padding"]
    ...
    # Save the image
    filepath = config.image_file_path
    background_from_limits(bound_limits, filepath + 'bg.png')
...
def background_from_limits(data_extents, path):
    ...
    zoom = 19  # Force highest resolution here
